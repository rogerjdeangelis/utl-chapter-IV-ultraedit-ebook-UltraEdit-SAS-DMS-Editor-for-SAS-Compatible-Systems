# utl-chapter-IV-ultraedit-ebook-UltraEdit-SAS-DMS-Editor-for-SAS-Compatible-Systems
       ...
       Here is the final Cheat Sheet
          ...
          Ehanced Key Mapping  
           ...
           UltraEdit Keys
                ...
                6  F12              save as
                7  Cltrl+F          Docked small persistent find box (very useful)  
                8  Alt+F3           Find (note if you have selected text, only that text will be searched)
                9  Ctrl+R           find/replace (note if you have selected text, only that text will be searched)
